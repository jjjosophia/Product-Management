    ...
    <div class="container"> <a class="navbar-brand" href="#">
      ...
      <div class="collapse navbar-collapse" id="navbar10">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"> <a class="nav-link" href="../users/user-list.html">使用者管理</a> </li>
          <li class="nav-item"> <a class="nav-link" href="list.html">最新消息管理</a> </li>
        ...
        <div class="col-md-12">
          ...
          <form action="insert" method="post" class="justify-content-center" enctype="multipart/form-data">
            ...
            <div class="form-group"> 
              <label>發佈日期</label> 
              <input type="text" class="form-control" id="published_date" name="published_date" value="" autocomplete="off"> 
            </div>
            <div class="form-group"> <label>標題</label> <input type="text" class="form-control" name="title"
                placeholder="輸入標題" value=""> </div>
            <div class="form-group"> <label>內容</label> <textarea name="content" id="" cols="30" rows="10"
