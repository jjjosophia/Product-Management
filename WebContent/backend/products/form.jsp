    ...
    <div class="container"> <a class="navbar-brand" href="#">
        ...
        <div class="collapse navbar-collapse" id="navbar10">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item"> <a class="nav-link" href="../users/list.html">使用者管理</a> </li>
            <li class="nav-item"> <a class="nav-link" href="../news/list.html">最新消息管理</a> </li>
            <li class="nav-item"> <a class="nav-link" href="list.html">產品管理</a> </li>
          </ul>
        </div>
    </div>
</nav>
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="list.html" class="btn btn-sm btn-primary my-3">回列表</a>
            ...
            <div class="form-group"> <label>產品名稱</label> <input type="text" class="form-control" name="name" placeholder="輸入產品名稱" value=""> </div>
            <div class="form-group"> <label>價格</label> <input type="text" class="form-control" name="price" placeholder="輸入價格" value=""> </div>
            <div class="form-group"> <label>產品說明</label> <textarea name="description" id="" cols="30" rows="10" class="form-control"></textarea></div>
